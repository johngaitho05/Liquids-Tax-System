...
class LiquidTaxSystem(models.Model):
    ...
    def advanced_compute_all(self, price_unit, quantity=1.0, currency=None, product=None, partner=None,
                             is_refund=False, discount=0.0, handle_price_include=True):
...
class AccountMove(models.Model):
    ...
    def _recompute_tax_lines(self, recompute_tax_base_amount=False):
        ...
        def _compute_base_line_taxes(base_line):
            ...
            balance_taxes_res = base_line.tax_ids._origin.advanced_compute_all(
            ...
            if base_line.currency_id:
                ...
                amount_currency_taxes_res = base_line.tax_ids._origin.advanced_compute_all(
...
class AccountMoveLine(models.Model):
    ...
    def _get_price_total_and_subtotal_model(self, price_unit, quantity, discount, currency, product, partner, taxes,
        ...
        # Compute 'price_total'.
        if taxes:
            taxes_res = taxes._origin.advanced_compute_all(price_unit, quantity=quantity, currency=currency,
                                                           product=product,
                                                           partner=partner,
    ...
    def _get_fields_onchange_balance_model(self, quantity, discount, balance, move_type, currency, taxes,
        ...
        if taxes and any(tax.price_include for tax in taxes):
            ...
            # 20            |               | 10% incl          | 20                | 20
            # 10            |               | 5%                | 10                | 10
            taxes_res = taxes._origin.advanced_compute_all(balance, quantity=quantity, currency=currency,
                                                           handle_price_include=False, product=self.product_id,
                                                           discount=discount)
